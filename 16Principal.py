...
def format_analysis_report(report):
    try:
        ...
        Estadísticas:
            Malicioso: {stats.get('malicioso', 'No disponible')}
            Sospechoso: {stats.get('sospechoso', 'No disponible')}
            No Detectado: {stats.get('No_detectado', 'No disponible')}
            Inofensivo: {stats.get('Inofensivo', 'No disponible')}
            Tiempo de Espera: {stats.get('tiempo_de_espera', 'No disponible')}
            Tiempo de Espera Confirmado: {stats.get('tiempo_de_espera_confirmado', 'No disponible')}
            Fallos: {stats.get('fallos', 'No disponible')}
            Tipo No Soportado: {stats.get('tipo_no_soportado', 'No disponible')}
        ...
        return f"Error formateando el reporte: clave {e} no encontrada"
